...
def got_text(message):
    ...
    # ответы по пунктам меню:
        ...
        btn_news = types.InlineKeyboardButton('Новости',
                                              url='https://www.hirobots.spb.ru/blog-1')
        markup_news.add(btn_news)
        bot.send_message(message.chat.id, 'Обо всех новостях наших клубов '
                                          'можно узнать в разделе:', reply_markup=markup_news)
